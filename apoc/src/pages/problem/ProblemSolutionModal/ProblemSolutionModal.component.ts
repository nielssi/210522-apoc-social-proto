...
@Component({
	templateUrl: 'ProblemSolutionModal.component.html'
})

export class ProblemSolutionModal {
	activeProblem : any;
    ...
    if (this.platform.is('core')) {
      ...
      return '../../assets/img/problems/' + gp_id + '_A.png'; //In browser
    }else{
      return './assets/img/problems/' + gp_id + '_A.png'; //On Device
    }
	}
