...
import { App, ViewController, NavController, LoadingController, AlertController, ToastController, ActionSheetController, Loading  } from 'ionic-angular';
//Services
...
/*
  Generated class for the GroupsIsMember page.

  See http://ionicframework.com/docs/v2/components/#navigation for more info on
  Ionic pages and navigation.
*/
@Component({
  selector: 'page-groups-is-member',
  templateUrl: 'groups-is-member.html'
})
export class GroupsIsMemberPage {
  ...
  ionViewDidLoad() {
    console.log('Hello GroupsIsMemberPage Page');
